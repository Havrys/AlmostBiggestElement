...
We say that the order of the songs on the tape is good if it minimizes the sum of times to access each song. Find the total length of the 
first m songs on the tape with the good order of songs.
...
Output
An integer, the total length of the first m songs on the tape with the good order of songs.*/
